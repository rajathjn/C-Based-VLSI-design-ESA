...
// ==============================================================
#ifndef __eq_sitofp_32ns_32bkb__HH__
#define __eq_sitofp_32ns_32bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(eq_sitofp_32ns_32bkb) {
    ...
    SC_CTOR(eq_sitofp_32ns_32bkb):  ACMP_sitofp_U ("ACMP_sitofp_U") {

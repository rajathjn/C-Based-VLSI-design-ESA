...
`define AUTOTB_DUT      eq
`define AUTOTB_DUT_INST AESL_inst_eq
`define AUTOTB_TOP      apatb_eq_top
`define AUTOTB_LAT_RESULT_FILE "eq.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "eq.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_eq_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_a 1
`define AESL_DEPTH_b 1
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.eq.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.eq.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.eq.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.eq.autotvin_b.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.eq.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.eq.autotvout_ap_return.dat"
module `AUTOTB_TOP;
